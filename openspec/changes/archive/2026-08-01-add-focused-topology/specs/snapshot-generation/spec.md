...
**Reason**: CHG-SNAPSHOT-004 withdraws the whole-product map: placement a reader can derive from each identifier carries no topological meaning, and no arrangement may replace it in which every artifact is rendered simultaneously. Its routes resolve in place to the Focused Topology.
