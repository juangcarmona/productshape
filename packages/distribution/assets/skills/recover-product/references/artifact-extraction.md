...
2. Record implications separately. A hypothesis about why ("requires approval because of fraud risk") is inference, labelled as such in the candidate body, never merged into an observed statement. The labelling convention is `references/provenance-format.md` under Body labelling.
