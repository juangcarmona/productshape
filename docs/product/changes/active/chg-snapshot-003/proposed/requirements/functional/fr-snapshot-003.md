...
verification:
  ...
  - scenario: The orientation view offers an entry point into the Product Landscape rather than a second spatial view
...
judgement. The orientation view MUST offer an entry point into the Product Landscape, which is where the
model is explored spatially; it MUST NOT attempt to be an alternative to it.
...
- The orientation view offers a way into the landscape, and does not duplicate it: no second spatial
  arrangement of artifacts appears on it.
