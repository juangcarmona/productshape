...
- Definition-only review: the applied model is accepted as the resulting baseline before implementation begins; the Product Change remains the record of semantic intent with status `applied`.
