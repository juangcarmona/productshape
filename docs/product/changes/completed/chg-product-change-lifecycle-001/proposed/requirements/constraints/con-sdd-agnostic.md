...
- Impossible: product artifacts that reference framework-native concepts, statuses or folders; framework-specific fields in the product model; or a product lifecycle coupled to a framework's change lifecycle. Archiving an SDD change can never approve or apply a Product Change, accept a Product Definition, or attest delivery.
