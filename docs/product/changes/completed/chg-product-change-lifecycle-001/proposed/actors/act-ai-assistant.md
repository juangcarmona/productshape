...
- Produce draft artifacts, Product Changes and semantic analyses that a human can review quickly and trust.
...
- Draft complete future-state artifacts inside Product Changes and help consumer documents cite the product intent they depend on.
...
- Never grants product approval, treats apply as acceptance, or claims that a merge proves implementation, verification, release or deployment.
- Never triggers apply implicitly; an explicit human instruction and an already approved change are required before an assistant may execute it.
