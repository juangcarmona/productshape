...
- Citation status is decided by resolving IDs and comparing content digests, a pure computation. An AI explanation of likely semantic impact may accompany the report but never determines the status.
