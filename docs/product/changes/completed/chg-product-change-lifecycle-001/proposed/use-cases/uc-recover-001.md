...
8. When every completion criterion is met, the tool produces a final report and the assistant hands over to the engineer. Recovery stops there. A human reviews `CHG-INITIAL`, may reject it or grant product approval, and only an approved change can later be applied and offered for merge acceptance.
...
- Nothing was approved, applied, merged or accepted by tooling or assistant.
