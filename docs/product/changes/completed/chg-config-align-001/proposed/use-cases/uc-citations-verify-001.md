...
- The repository's `warnings-as-errors` configuration makes stale citations (PRODUCT061) fail the run, blocking the pipeline; their reported severity remains `warning`.
