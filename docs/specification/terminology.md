...
files are regenerated by `prodshape integration update` and checked for manual modification by
`prodshape doctor`. Management covers absence as well as presence: a managed file the current
