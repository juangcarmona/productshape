...
The supported published CLI baseline is `@prodshape/cli@0.18.0`. Every stable public CLI release from `0.1.0` through that baseline is recorded below; package-specific dependency changes remain in each package's changelog.
...
[unreleased]: https://github.com/juangcarmona/productshape/compare/@prodshape/cli@0.18.0...HEAD
