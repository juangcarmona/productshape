...
is grounded: *"I notice there's no use case covering X — is your idea filling that gap, or is
it something else entirely?"* A bad question is generic: *"What actors are involved?"*
...
- If the user asks you to implement something: *"Exploration mode doesn't implement — let's
