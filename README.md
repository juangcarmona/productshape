...
Requires Node.js >= 22. The supported published baseline is **`@prodshape/cli@0.19.0`**.

```bash
npm install -g @prodshape/cli@0.19.0
# or run it once, without installing
pnpm dlx @prodshape/cli@0.19.0 --help
```
...
npm init -y && npm install --save-dev --save-exact @prodshape/cli@0.19.0
...
```bash
set -eu
PRODSHAPE_PACKAGE="${PRODSHAPE_PACKAGE:-@prodshape/cli@0.19.0}"
