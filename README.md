...
Requires Node.js >= 22. The supported published baseline is **`@prodshape/cli@0.13.1`**.

```bash
npm install -g @prodshape/cli@0.13.1
# or run it once, without installing
pnpm dlx @prodshape/cli@0.13.1 --help
```
...
```bash
set -eu
PRODSHAPE_PACKAGE="${PRODSHAPE_PACKAGE:-@prodshape/cli@0.13.1}"
